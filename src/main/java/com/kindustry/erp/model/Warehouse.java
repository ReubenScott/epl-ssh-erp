...
public class Warehouse implements java.io.Serializable {
  ...
  /** full constructor */
  public Warehouse(String name, String myid, Integer organizationId, String organizationName, Integer managerId, String managerName, String tel, String address,
    String description, Date created, Date lastmod, String status, Integer creater, Integer modifyer) {
    this.name = name;
    this.myid = myid;
