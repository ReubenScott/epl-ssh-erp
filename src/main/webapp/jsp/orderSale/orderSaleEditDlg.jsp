...
<script type="text/javascript">
	...
	$(function(){
		$dg = $("#dg");
		$dg.datagrid({
			url :"orderSale/orderSaleAction!findOrderSaleLineList.action?orderSaleId="+$("#tempId").val(),
			width : 'auto',
			...
			singleSelect:true,
			columns:[[
				{field : 'myid',title : '物料编码',width : parseInt($(this).width()*0.07),editor : {type:'validatebox',options:{required:true}}},
		...
		$cb.combogrid({
			...
			onSelect:function(rowIndex,rowData){
			    ...
			    $("#customerContact").combobox({
			    	width:171,
			    	url:"cstContact/cstContactAction!findCustomerContactListCombobox.action?customerId="+rowData.customerId,
			    	valueField: 'name',
			    	textField: 'name',
							...
							<input name="deleted" id="deleted"  type="hidden"/>
							 <table class="table">
								 ...
								 <tr>
									...
									<th>联系人</th>
									<td><input id="customerContact" name="customerContact" type="text" class="easyui-textbox easyui-validatebox"/><img src="extend/area.png" style="margin-left:2px;margin-bottom: -5px;cursor: pointer;" onclick="addAreaOpenDlg();"/></td>
									<th>电话</th>
								  ...
								  <tr>
									...
									<th>销售部门</th>
									<td><input id="saleOrganizationId" name="saleOrganizationId" type="text" class="easyui-textbox easyui-validatebox"/><input id="saleOrganizationName" name="saleOrganizationName" type="hidden"/><img src="extend/area.png" style="margin-left:2px;margin-bottom: -5px;cursor: pointer;" onclick="addAreaOpenDlg();"/></td>
									<th>币别</th>
