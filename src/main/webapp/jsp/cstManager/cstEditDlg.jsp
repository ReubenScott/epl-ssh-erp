...
<script type="text/javascript">
	...
	$(function(){
		...
		$grid=$dg.datagrid({
			...
			singleSelect:true,
			columns:[[
				{field : 'name',title : '联系人名称',width : parseInt($(this).width()*0.07),editor : {type:'validatebox',options:{required:true}}},
			    ...
			    {field:'email',title:'电子邮箱',width:parseInt($(this).width()*0.09),alian:'left',editor:{
			    	type:'validatebox',
			    	options:{
			    		validType:'email'
			    	}
						 ...
						 <table class="table">
							   <tr>
								 ...
								 <tr>
									...
									<th>公司规模</th>
									<td><input id="sizeId" name="sizeId" type="text" required="required" class="easyui-textbox easyui-numberbox" /><input id="sizeName" name="sizeName" type="hidden"/></td>
								 </tr>
								 <tr>
								    <th>开业年份</th>
									<td><input id="setupDate" name="setupDate" type="text" data-options="editable:false"  class="easyui-textbox easyui-datebox"/></td>
									<th>注册资金</th>
									<td><input id="capital" name="capital" type="text" class="easyui-textbox easyui-numberbox" required="required"/></td>
								    <th>员工人数</th>
									<td><input id="empCount" name="empCount" type="text" class="easyui-textbox easyui-numberbox" required="required"/></td>
								 </tr>
								 <tr>
								    <th>营业总额</th>
									<td><input id="totalSales" name="totalSales" type="text" class="easyui-textbox easyui-validatebox"/></td>
									<th>交易状态</th>
									<td><select id="customerStatus" data-options="editable:false" class="easyui-combobox" name="customerStatus" style="width:171px;">
						 ...
						 <table class="table">
							 <tr>
								 ...
								 <tr>
									...
									<th>扣税类别</th>
									<td><select id="deductionTax" data-options="editable:false" class="easyui-combobox" name="deductionTax" style="width:171px;">
								 ...
								 <tr>
								    <th>应用税率</th>
									<td><input id="tax" name="tax" type="text" re class="easyui-textbox easyui-numberbox" required="required"/></td>
									<th>立账方式</th>
									<td><input id="setupAccount" name="setupAccount" type="text" required="required" class="easyui-textbox easyui-numberbox"/></td>
								 </tr>
						</table>
						</fieldset>
				</div>
